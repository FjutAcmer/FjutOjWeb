        ...
        <el-card class="box-card" :body-style="{ padding: '0px' }">
            <el-form :model="form" class="el-form">
                ...
                <el-form-item prop="pwd2">
                    <el-input show-password v-model="form.pwd2" class="el-input" ref="pwd2" placeholder="确认密码"></el-input>
                </el-form-item>
                <el-form-item>
...
export default {
    ...
    methods:{
        async editUser(){
            if(this.$refs.motto.value==''&&this.$refs.email.value==''&&
            this.$refs.school.value==''&&this.$refs.nick.value==''&&
            this.$refs.pwd.value==''){
