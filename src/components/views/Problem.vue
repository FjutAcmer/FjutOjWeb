    ...
    <div class="problem">
        <el-card :body-style="{ padding: '0px' }" class="box-card">
            ...
            <el-table style="width:100%;" :data="this.tableData" v-loading="loading">
                    ...
                    <el-table-column prop="Title" label="Title" style="width:60%"><template slot-scope="scope"><div style="cursor:pointer;color:blue" @click="toSubmit(scope.row)">{{scope.row.Title}}</div> </template></el-table-column>
