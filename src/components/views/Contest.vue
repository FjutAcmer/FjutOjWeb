<template>
    <div class="contest">
        <el-card :body-style="{ padding: '0px' }" class="box-card">
            ...
            <div class="contest-filter">
                <el-row  type="flex">
                    ...
                    <el-col style="width:20%">
                        <el-select placeholder="请选择权限" size="mini">
                        </el-select>
                    </el-col>
                    <el-col style="width:20%">
                        <el-select placeholder="请选择状态" size="mini">
                        </el-select>
                    </el-col>
            ...
            <el-pagination style="float:left" layout="prev, pager, next" :current-page="currentPage" @current-change="getList" :total="currentTotal*10"></el-pagination>
            <el-table style="width:100%;" :data="tableData">
                    <el-table-column prop="id" label="#" width = "150"></el-table-column>
                    <el-table-column label="名称" width = "400"><template slot-scope="scope"><div @click="toContestInfo(scope.row)">{{scope.row.name}}</div> </template></el-table-column>
    ...
    methods:{
        ...
        async toContestInfo(row){
            ...
            if(sessionStorage.getItem("username")==""){
                ...
                this.$prompt('请输入密码', '提示', {confirmButtonText: '确定',cancelButtonText: '取消',
                }).then(({ value }) => {
